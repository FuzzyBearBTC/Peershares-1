...
static const int64 IPO_SHARES = 1000000; // Total number of shares to create using proof of work (intented for IPO)
...
static const uint256 hashGenesisBlockOfficial("0x000000002fee993560568205c733ccb56cb62af7471ef1afad2fe2559e72a284");
